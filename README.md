...
- `P4_Functions_and_Generators`：已正式开始；`PART opener`
  `C16_Function_Basics` 与 `normal` 章节 `C17_Scopes` 均已完成最终收束。
  下一正式入口为 `C18_Arguments`（`normal`），应从
  [`docs/C18_ARGUMENTS_STARTUP_TEMPLATE.md`](docs/C18_ARGUMENTS_STARTUP_TEMPLATE.md)
