...
- `P4_Functions_and_Generators`：已正式开始；`PART opener`
  `C16_Function_Basics` 与 `normal` 章节 `C17_Scopes`、`C18_Arguments`
  均已完成最终收束。下一正式入口为 `C19_Advanced_Function_Topics`
  （`normal`），应从
  [`docs/C19_ADVANCED_FUNCTION_TOPICS_STARTUP_TEMPLATE.md`](docs/C19_ADVANCED_FUNCTION_TOPICS_STARTUP_TEMPLATE.md)
