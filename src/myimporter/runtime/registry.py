...
from src.myimporter.utils.settings import PLUGINREGISTRY_PLUGIN_STATE
    ...
    def to_dict(self):
        ...
        for name, info in self._plugins.items():
            ...
            result[name] = {
                ...
                "provides": self.get_providers('dark'),  # 这里假设 'dark' 是一个示例能力，可以根据实际情况替换为需要的能力，通常应该为变量，这里硬编码是为了示例演示
